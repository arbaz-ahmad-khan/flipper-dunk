...
class ThreeLevel extends Phaser.Scene {
	...
	editorCreate() {
		...
		// rectangle_3
		const rectangle_3 = this.add.rectangle(886, 933, 75, 75);
		...
		// rectangle_33
		const rectangle_33 = this.add.rectangle(795, 916, 50, 200);
		rectangle_33.visible = false;
		rectangle_33.isFilled = true;
		obstaclesContainer.add(rectangle_33);

		// rectangle_34
		const rectangle_34 = this.add.rectangle(894, 1040, 250, 50);
	...
	create() {
		...
		// back-net
		const net1 = this.add.image(886, 840, "backward-Net");
		net1.scaleX = 0.7;
		net1.scaleY = 0.7;
		// ball
		...
		// front-net
		const net_1 = this.add.image(886, 840, "Net-1");
		net_1.scaleX = 0.7;
		net_1.scaleY = 0.7;
